 ...
 */
package cn.yy.cobar.client.router.config.vo;
...
public class InternalRule {
	 ...
	 * 
	 * @param merger,
	 *            the bean name in the container.
	 */
	...
	public String toString() {
		return "InternalRule [namespace=" + namespace + ", shardingExpression=" + shardingExpression + ", shards="
				+ shards + ", sqlmap=" + sqlmap + "]";
	}
}
